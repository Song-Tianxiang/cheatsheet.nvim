...
local mappings_tb = require("cheatsheet").config.mappings -- default & user mappings
local utils = require("cheatsheet.utils")
local isValid_mapping_TB = utils.isValid_mapping_TB
...
return function()
	...
	for i = 0, #ascii_header - 1, 1 do
		vim.api.nvim_buf_add_highlight(buf, cheatsheet, "NvChAsciiHeader", i, 0, -1)
	end
